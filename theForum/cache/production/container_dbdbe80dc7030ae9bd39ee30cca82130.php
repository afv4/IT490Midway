...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000000379d619000000004e279ab7(
...
class phpbbtemplatetwiglexer_000000000379d619000000004e279ab7 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a048417e0f68210970412 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a048417e0f70179390630 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a048417e0f48019034773 = array(
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, 'set_environment', array('env' => $env), $this->initializer5a048417e0f70179390630);

        return $this->valueHolder5a048417e0f68210970412->set_environment($env);
    }
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a048417e0f70179390630);

        return $this->valueHolder5a048417e0f68210970412->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a048417e0f70179390630);

        return $this->valueHolder5a048417e0f68210970412->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a048417e0f70179390630 = $initializer;
    }
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, '__get', array('name' => $name), $this->initializer5a048417e0f70179390630);

        if (isset(self::$publicProperties5a048417e0f48019034773[$name])) {
            return $this->valueHolder5a048417e0f68210970412->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a048417e0f68210970412;
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a048417e0f70179390630);
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, '__isset', array('name' => $name), $this->initializer5a048417e0f70179390630);
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, '__unset', array('name' => $name), $this->initializer5a048417e0f70179390630);
    ...
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, '__clone', array(), $this->initializer5a048417e0f70179390630);

        $this->valueHolder5a048417e0f68210970412 = clone $this->valueHolder5a048417e0f68210970412;
    }

    public function __sleep()
    {
        $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, '__sleep', array(), $this->initializer5a048417e0f70179390630);

        return array('valueHolder5a048417e0f68210970412');
    }
    ...
    {
        return $this->initializer5a048417e0f70179390630;
    }
    ...
    {
        return $this->initializer5a048417e0f70179390630 && $this->initializer5a048417e0f70179390630->__invoke($this->valueHolder5a048417e0f68210970412, $this, 'initializeProxy', array(), $this->initializer5a048417e0f70179390630);
    }
    ...
    {
        return null !== $this->valueHolder5a048417e0f68210970412;
    }
    ...
    {
        return $this->valueHolder5a048417e0f68210970412;
    }
