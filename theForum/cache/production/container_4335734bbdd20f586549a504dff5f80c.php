...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_000000004670ed53000000007a4c67c8(
...
class phpbbtemplatetwiglexer_000000004670ed53000000007a4c67c8 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a04842f78588572588479 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a04842f7858f317753219 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a04842f7856b118346015 = array(
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, 'set_environment', array('env' => $env), $this->initializer5a04842f7858f317753219);

        return $this->valueHolder5a04842f78588572588479->set_environment($env);
    }
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a04842f7858f317753219);

        return $this->valueHolder5a04842f78588572588479->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a04842f7858f317753219);

        return $this->valueHolder5a04842f78588572588479->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a04842f7858f317753219 = $initializer;
    }
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, '__get', array('name' => $name), $this->initializer5a04842f7858f317753219);

        if (isset(self::$publicProperties5a04842f7856b118346015[$name])) {
            return $this->valueHolder5a04842f78588572588479->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a04842f78588572588479;
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a04842f7858f317753219);
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, '__isset', array('name' => $name), $this->initializer5a04842f7858f317753219);
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, '__unset', array('name' => $name), $this->initializer5a04842f7858f317753219);
    ...
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, '__clone', array(), $this->initializer5a04842f7858f317753219);

        $this->valueHolder5a04842f78588572588479 = clone $this->valueHolder5a04842f78588572588479;
    }

    public function __sleep()
    {
        $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, '__sleep', array(), $this->initializer5a04842f7858f317753219);

        return array('valueHolder5a04842f78588572588479');
    }
    ...
    {
        return $this->initializer5a04842f7858f317753219;
    }
    ...
    {
        return $this->initializer5a04842f7858f317753219 && $this->initializer5a04842f7858f317753219->__invoke($this->valueHolder5a04842f78588572588479, $this, 'initializeProxy', array(), $this->initializer5a04842f7858f317753219);
    }
    ...
    {
        return null !== $this->valueHolder5a04842f78588572588479;
    }
    ...
    {
        return $this->valueHolder5a04842f78588572588479;
    }
