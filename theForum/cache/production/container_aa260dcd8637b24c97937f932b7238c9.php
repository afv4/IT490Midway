...
class phpbb_cache_container extends Symfony\Component\DependencyInjection\ContainerBuilder
{
    ...
    public function getTemplate_Twig_LexerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['template.twig.lexer'] = new phpbbtemplatetwiglexer_0000000074fcf95d0000000013f38e34(
...
class phpbbtemplatetwiglexer_0000000074fcf95d0000000013f38e34 extends \phpbb\template\twig\lexer implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder5a0f185dd304b679410591 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer5a0f185dd3051587420838 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties5a0f185dd3034934086101 = array(
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, 'set_environment', array('env' => $env), $this->initializer5a0f185dd3051587420838);

        return $this->valueHolder5a0f185dd304b679410591->set_environment($env);
    }
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, 'tokenize', array('code' => $code, 'filename' => $filename), $this->initializer5a0f185dd3051587420838);

        return $this->valueHolder5a0f185dd304b679410591->tokenize($code, $filename);
    }
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, 'fix_begin_tokens', array('code' => $code, 'parent_nodes' => $parent_nodes), $this->initializer5a0f185dd3051587420838);

        return $this->valueHolder5a0f185dd304b679410591->fix_begin_tokens($code, $parent_nodes);
    }
    ...
    {
        $this->initializer5a0f185dd3051587420838 = $initializer;
    }
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, '__get', array('name' => $name), $this->initializer5a0f185dd3051587420838);

        if (isset(self::$publicProperties5a0f185dd3034934086101[$name])) {
            return $this->valueHolder5a0f185dd304b679410591->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder5a0f185dd304b679410591;
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer5a0f185dd3051587420838);
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, '__isset', array('name' => $name), $this->initializer5a0f185dd3051587420838);
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, '__unset', array('name' => $name), $this->initializer5a0f185dd3051587420838);
    ...
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, '__clone', array(), $this->initializer5a0f185dd3051587420838);

        $this->valueHolder5a0f185dd304b679410591 = clone $this->valueHolder5a0f185dd304b679410591;
    }

    public function __sleep()
    {
        $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, '__sleep', array(), $this->initializer5a0f185dd3051587420838);

        return array('valueHolder5a0f185dd304b679410591');
    }
    ...
    {
        return $this->initializer5a0f185dd3051587420838;
    }
    ...
    {
        return $this->initializer5a0f185dd3051587420838 && $this->initializer5a0f185dd3051587420838->__invoke($this->valueHolder5a0f185dd304b679410591, $this, 'initializeProxy', array(), $this->initializer5a0f185dd3051587420838);
    }
    ...
    {
        return null !== $this->valueHolder5a0f185dd304b679410591;
    }
    ...
    {
        return $this->valueHolder5a0f185dd304b679410591;
    }
